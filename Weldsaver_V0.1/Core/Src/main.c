...
#define MAX_VALUES1 40

#define  MAX_VALUES_flow 30
#define MAX_VALUES_flow1 30
//#define TIMCLOCK   108000000
    ...
    /* USER CODE BEGIN 3 */
			  ...
			  if (count_adc >= MAX_VALUES)
			  {
				  average = (float)sum / MAX_VALUES;
					  ...
					  temp1=((temp1-1000)/(1000*0.00391))-56;
			  ...
			  if (celcious_flag)
			  {
				...
				if (fahrenheit_flag)
				{
				  ...
				  temp1=(((average*0.00080566*1.232)-1)*R0)-39;

				  temp1=((temp1-R0)/(R0*0.00391))-56;
				  temp1=(temp1 * 9/5) + 32;
				}
	  	 	  //adc1
			 ...
			 // printf ("Sensor Value = %d \n\r", sensor_value); // Running at 38400, though set at 115200
			  ...
			  sensor_values1[count_adc1] = sensor_value1;
				  ...
				  if (count_adc1 >= MAX_VALUES1)
					  {
						  average1 = (float)sum1 / MAX_VALUES1;
							  ...
							  temp2=(((average1*0.00080566*1.232)-1)*R0)-39.0;

							  temp2=((temp2-R0)/(R0*0.00391))-56;
				  ...
				  if (celcious_flag)
				  {
				  temp2=(((average1*0.00080566*1.232)-1)*R0)-39;
...
static void MX_TIM13_Init(void)
{
  ...
  htim13.Init.Prescaler = 65535-1;
  htim13.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim13.Init.Period = 11596;
...
static void MX_TIM14_Init(void)
{
  ...
  htim14.Init.Prescaler = 65535-1;
  htim14.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim14.Init.Period = 11596;
