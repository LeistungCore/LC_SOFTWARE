...
void adc_calculations(void)
{
	...
	//					  temp1=(1000*((average*0.00080566*1.232)-1))-39;
	//
	//					  temp1=((temp1-1000)/(1000*0.00391));

					  Vout_final=average*0.00080566;
					  Vout=(Vout_final*53)/43;
					  R_PT1000 =(((Vout/1.086)-1)*1000)-39;
	...
	//
	//							  temp2=((temp2-R0)/(R0*0.00391))-53.5;

								  Vout_final_1=average1*0.00080566;
								  Vout_1=(Vout_final_1*53)/43;
								  R_PT1000_1 =(((Vout_1/1.086)-1)*1000)-39;
	...
	//					temp2=((temp2-R0)/(R0*0.00391))-56;
							  ...
							  Vout_final_1=average1*0.00080566;
							  Vout_1=(Vout_final_1*53)/43;
							  R_PT1000_1 =(((Vout_1/1.0866)-1)*1000)-39;
							  temp2=(((R_PT1000_1/1000)-1)/(0.00391)-2);
							  temp2=(temp2 * 9/5) + 32;
						}
}
