...
//for flow
 ...
 volatile int flow_fault_value=5;
...
//                lv_obj_align(Temp_label5, LV_ALIGN_LEFT_MID, 10, 65);
                ...
                lv_obj_align(Temp_label6, LV_ALIGN_LEFT_MID, 10, 5);
                        ...
                        lv_dropdown_set_options( Unit_Temp, "°C\n"
                          "°f"  );
                           ...
                           lv_obj_set_style_pad_bottom( Unit_Temp, 5, 0); // Bottom padding for options
                            ...
                            lv_obj_align( Unit_Temp, LV_ALIGN_TOP_LEFT, 220, 90); // Align dropdown next to the label at (X + 60)
