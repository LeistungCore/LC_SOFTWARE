...
float currentVar = 0.0;     // Variable current
float voltageVar = 0.0;     // Variable voltage
float currentActual = 0.0;  // Actual current
float voltageActual = 0.0;  // Actual voltage
float phaseEnergy[3];       // 3 phase energy consumption
float gasConsumption = 0.0; // Gas consumption
...
void loop() {
  // Read from ADC channels (via I2C)
  currentVar = readADC(0);      // Variable current (ADC channel 0)
  voltageVar = readADC(1);      // Variable voltage (ADC channel 1)
